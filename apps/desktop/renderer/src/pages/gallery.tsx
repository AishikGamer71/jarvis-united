      ...
      <div className="flex items-center justify-between pb-6 border-b border-white/5 mb-6 shrink-0">
        <div className="flex items-center gap-3 text-zinc-100">
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-500 font-mono mt-0.5">GENERATED BY JARVIS</p>
          </div>
        </div>
                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-black via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-4 translate-y-2 group-hover:translate-y-0">
                    ...
                    <div className="flex gap-2 justify-end">
                      <motion.button
                        ...
                        className="p-2 bg-white/10 text-white rounded-lg hover:bg-blue-600 hover:text-white transition-all backdrop-blur-md border border-white/10 cursor-pointer"
                      ...
                      <motion.button
                        ...
                        className="p-2 bg-white/10 text-white rounded-lg hover:bg-red-600 hover:text-white transition-all backdrop-blur-md border border-white/10 cursor-pointer"
                        title="Delete Image"
                      >
