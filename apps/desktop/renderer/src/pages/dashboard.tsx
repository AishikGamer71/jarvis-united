        ...
        >
          ...
          {isVideoOn && (
            <motion.button
              ...
              className="absolute top-2 right-2 z-30 p-1.5 rounded-md bg-black/50 text-emerald-400 border border-emerald-500/20 hover:bg-emerald-500 hover:text-black transition-all cursor-pointer"
            >
            ...
            {selectedFile && (
              <div className="flex items-center justify-between bg-emerald-900/20 border border-emerald-500/20 p-2 rounded-lg mb-2">
                ...
                <motion.button 
                  ...
                  className="p-1 hover:bg-white/10 rounded-md text-zinc-400 hover:text-white transition-colors cursor-pointer"
                >
                  <RiCloseLine />
                </motion.button>
              </div>
