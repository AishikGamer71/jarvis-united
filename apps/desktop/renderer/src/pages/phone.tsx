          ...
          <div className="flex flex-wrap justify-center gap-10">
            {deviceHistory.map((dev, i) => (
              <motion.button
                ...
                className="w-55 h-110 bg-black border-8 border-zinc-900 rounded-[3rem] relative flex flex-col p-2 group hover:border-emerald-500/50 transition-colors duration-500 shadow-2xl hover:shadow-[0_0_40px_rgba(16,185,129,0.2)] cursor-pointer"
              >
                ...
                <div className="flex-1 bg-linear-to-b from-zinc-900 to-black rounded-[2.2rem] overflow-hidden flex flex-col items-center justify-center p-6 relative w-full">
                  ...
                  <div className="flex items-center gap-2 text-[10px] font-mono text-zinc-500 group-hover:text-emerald-300 z-10 transition-colors">
            ...
            >
              ...
              <span className="text-xs font-bold text-zinc-500 group-hover:text-emerald-400 tracking-widest uppercase transition-colors">
                NEW DEVICE
              </span>
            </motion.button>
          </div>
                ...
                <div className="pb-3 w-full">
                  ...
                  <div className="relative group w-full">
                    ...
                    <motion.button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-emerald-600 hover:text-emerald-400 hover:bg-emerald-900/30 rounded-lg transition-colors cursor-pointer"
                      title="Copy command"
                    >
                      {copied ? (
      ...
      <div className="w-1/4 flex flex-col h-162.5 relative">
        <div className="bg-[#111] border border-white/5 rounded-2xl p-6 flex flex-col h-full shadow-lg">
          ...
          <motion.button
            ...
            className="w-full py-4 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white font-bold rounded-xl tracking-widest transition-colors duration-300 border border-red-500/30 flex items-center justify-center gap-3 cursor-pointer"
          >
