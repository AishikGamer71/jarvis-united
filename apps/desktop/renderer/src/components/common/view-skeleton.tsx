...
const ViewSkeleton = () => {
  return (
    <div className="w-full h-full p-8 animate-in fade-in duration-500">
      <div className="w-full h-full bg-zinc-950/40 backdrop-blur-sm border border-white/5 rounded-2xl shadow-xl p-6 flex flex-col gap-6 relative overflow-hidden">
